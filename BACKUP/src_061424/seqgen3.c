...
//
// The purpose of this code is to provide an example for how to implement a set 
// of periodic services in Linux user space without specialized hardware like
// an auxiliary programmable interval timer and/or real-time clock.
//
